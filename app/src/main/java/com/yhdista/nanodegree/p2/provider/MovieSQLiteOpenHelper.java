...
public class MovieSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_MOVIE = "CREATE TABLE IF NOT EXISTS "
            ...
            + MovieColumns.ORIGINAL_LANGUAGE + " TEXT NOT NULL DEFAULT 'en', "
            + MovieColumns.ORIGINAL_TITLE + " TEXT NOT NULL DEFAULT 'Mad Max: Fury Road', "
            + MovieColumns.OVERVIEW + " TEXT NOT NULL DEFAULT 'blabla', "
            + MovieColumns.RELEASE_DATE + " INTEGER NOT NULL DEFAULT 123456789, "
            + MovieColumns.POSTER_PATH + " TEXT NOT NULL DEFAULT '/kqjL17yufvn9OVLyXYpvtyrFfak.jpg', "
            + MovieColumns.POPULARITY + " REAL NOT NULL DEFAULT 51.773842, "
